<div class="p-4" style="flex-basis: 300px;">
  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
    <!-- <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="https://dummyimage.com/721x401" alt="blog" /> -->
    <img class="w-full object-cover object-center" src="{{ $data->image1 }}" alt="blog" />
    <div class="p-4">
      <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">
        @php #CATEGORY種類 @endphp
        {{ $data->pal_id }}
      </h2>
      <h1 class="title-font text-lg font-medium text-gray-900 mb-1">
        {{ $data->zh_name }}({{ $data->en_name }})
      </h1>
      ...
      <p class="leading-relaxed text-xs mb-3">
        ...
        {{ $attr->zh_name . ' ' . $attr->number }}
        </div>
        @endforeach
      </p>
      <!-- <div class="flex items-center flex-wrap">
                <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">詳情
